...
export function WithdrawButton() {
  ...
  const goalReached = completionRate !== undefined ? Number(completionRate) >= 100 : false;
  return (
    <div className="withdraw-section">
      ...
      <button
        onClick={() => writeContract({ ...contract, functionName: "withdrawTips" })}
        disabled={isPending || isConfirming || !goalReached}
        className="btn-withdraw"
      >
        {isPending ? "지갑 확인 중..." : isConfirming ? "처리 중..." : "팁 출금하기"}
      </button>
